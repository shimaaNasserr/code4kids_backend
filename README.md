...
| Method | Endpoint                                  | Description            |
| ------ | ----------------------------------------- | ---------------------- |
| GET    | `/api/lessons/<lesson_id>/assignments/`   | Get lesson assignments |
| POST   | `/api/submissions/create/`                | Submit an assignment   |
| PATCH  | `/api/submissions/<submission_id>/grade/` | Grade a submission     |
